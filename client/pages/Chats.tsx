  ...
  if (selectedChat && currentChat) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-brich-dark via-slate-900 to-brich-dark flex flex-col">
        ...
        {/* Bottom Navigation */}
        <div className="bg-gradient-to-t from-brich-dark via-brich-dark/98 to-brich-dark/95 backdrop-blur-2xl border-t border-white/15">
        ...
        <div className="max-w-md mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">{totalUnreadMessages} mensajes sin leer</p>
            </div>
          </div>
