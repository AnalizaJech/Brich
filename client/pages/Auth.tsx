...
export default function Auth() {
  const [step, setStep] = useState<"login" | "register" | "dni-verify">(
    "login",
  );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">
            Tu app de citas con verificación segura
          </p>
        </div>
            ...
            <div className="flex items-center space-x-2">
              {step !== "login" && (
                <Button
                  ...
                  size="icon"
                  onClick={() =>
                    setStep(step === "dni-verify" ? "register" : "login")
                  }
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              {step === "login" && (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="login-dni" className="text-white">
                      DNI
                    </Label>
                    <Input
                      id="login-dni"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="login-phone" className="text-white">
                      Teléfono
                    </Label>
                    <Input
                      id="login-phone"
              ...
              {step === "register" && (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="reg-dni" className="text-white">
                      DNI *
                    </Label>
                    <Input
                      id="reg-dni"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reg-birth" className="text-white">
                      Fecha de nacimiento *
                    </Label>
                    <Input
                      id="reg-birth"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="reg-bio" className="text-white">
                      Biografía
                    </Label>
                    <textarea
                      id="reg-bio"
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        ...
                        identidad con una foto de tu DNI.
                      </p>
                    </div>
