...
export default function InteractiveMap({ activeMode, onRadiusChange }: InteractiveMapProps) {
  ...
  const filteredPins = mapPins.filter(pin => 
    pin.mode === activeMode && pin.distance <= radius
  );
    ...
    <div className="relative h-48 bg-gradient-to-br from-brich-blue-900/20 to-brich-red-900/20 rounded-lg overflow-hidden">
      ...
      <div className="absolute inset-0">
        <svg className="w-full h-full opacity-20" viewBox="0 0 200 120">
          ...
          <line x1="50" y1="0" x2="50" y2="120" stroke="white" strokeWidth="1" />
          <line x1="100" y1="0" x2="100" y2="120" stroke="white" strokeWidth="1" />
          <line x1="150" y1="0" x2="150" y2="120" stroke="white" strokeWidth="1" />
          
          {/* Diagonal streets */}
          <line x1="0" y1="0" x2="80" y2="60" stroke="white" strokeWidth="0.5" />
          <line x1="120" y1="60" x2="200" y2="120" stroke="white" strokeWidth="0.5" />
        </svg>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="relative">
            <div className={`w-4 h-4 ${modeConfig[activeMode]} rounded-full shadow-lg`} />
          ...
          {filteredPins.map((pin) => (
            ...
            >
              <div className={`w-full h-full ${modeConfig[pin.mode]} rounded-full`} />
            </div>
          ))}
        </div>
      </div>
